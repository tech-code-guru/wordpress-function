...
<?php $image=wp_get_attachment_image_src(get_post_thumbnail_id($abc->ID),'single-post-thumbnail'); ?>
						...
						<div class="clearfix single_content">
							...
							<div class="clearfix post_detail">
								<h2><a href="<?php echo $abc->guid; ?>"><?php echo $abc->post_title; ?></a></h2>
								<div class="clearfix post-meta">
									<p><span><i class="fa fa-user"></i> <?php echo the_author_meta( 'user_nicename' , $abc->post_author );  ?>
</span> <span><i class="fa fa-clock-o"></i> <?php echo get_the_date('d'); ?> <?php echo get_the_date('M'); ?> <?php echo get_the_date('Y'); ?></span> <span><i class="fa fa-comment"></i> <?php echo $abc->comment_count; ?> comments</span> <span><i class="fa fa-folder"></i> 	<?php
					$category = get_the_category($abc->ID);
...
?></span></p>
								...
								<div class="clearfix post_excerpt">
									...
									<p><?php echo $abc->post_excerpt; ?> </p>
								</div>
								<a href="<?php echo $abc->guid; ?>">Continue Reading</a>
							</div>
						</div>
						<?php
}
